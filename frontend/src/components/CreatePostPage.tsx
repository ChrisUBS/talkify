...
export default function CreatePostPage() {
    ...
    if (sessionStatus === 'loading') {
        return <div className="container mx-auto px-4 py-16 max-w-3xl">Cargando...</div>
    }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const newPost = await postService.createPost({
                ...
                status,
                // Usamos la URL de la imagen seleccionada de Pexels
                            ...
                            <div className="mb-4 relative">
                                <div className="relative h-48 rounded-lg overflow-hidden">
                                    <Image
                                        ...
                                        alt={selectedImage.alt || `Foto por ${selectedImage.photographer}`}
                                        fill
                        ...
                        {title.trim() && (
                            <div className="mb-6">
                                <div className="flex items-center mb-2">
                                    <h3 className="text-sm text-gray-700">Imágenes sugeridas (Pexels)</h3>
                                </div>
